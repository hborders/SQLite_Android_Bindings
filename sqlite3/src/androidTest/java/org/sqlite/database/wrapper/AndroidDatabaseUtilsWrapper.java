...
public final class AndroidDatabaseUtilsWrapper implements DatabaseUtilsWrapper<
        ...
        > {
    @Override
    public void bindObjectToProgram(
            SQLiteStatementWrapper<SQLiteStatement> prog, int index, Object value) {
    ...
    @Override
    public String stringForQuery(SQLiteStatementWrapper<SQLiteStatement> prog,
                                 String[] selectionArgs) {
